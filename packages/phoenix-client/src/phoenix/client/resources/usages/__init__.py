...
class Usages:
    ...
    def insert_user_info(
        self,
        *,
        user_info_dataframe: Optional["pd.DataFrame"] = None,
        project_name: str,
        ...
        if user_info_dataframe is None:
            raise ValueError("Provide exactly 'user_info_dataframe'")
        
        json_data = user_info_dataframe.to_json(orient="records")
    ...
    def insert_message_info(
        self,
        *,
        message_info_dataframe: Optional["pd.DataFrame"] = None,
        project_name: str,
        timeout: Optional[int] = DEFAULT_TIMEOUT_IN_SECONDS,
    ):
        try:
        ...
        if message_info_dataframe is None:
            raise ValueError("Provide exactly 'message_info_dataframe'")
